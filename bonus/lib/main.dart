              ...
              children: [
                ...
                Container(
                    ...
                    child: Column(
                      children: [
                        ListTile(
                          title: Text("Home (Jl. Sariwangi Dalam No. 87)"),
                          subtitle: Text(
                            "Jl. Sariwangi Dalam No.87, Sukawarna, Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.",
                            style: TextStyle(
                        ...
                        ListTile(
                          title: Text("Dago Suites Apartement"),
                          subtitle: Text(
                            "Jl. Sangkuriang No. 13, RT.1/RW/11. Dago Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.",
                            style: TextStyle(
                              overflow: TextOverflow.ellipsis,
                            ),
                          ),
      ...
      onPressed: () {
        ...
        showDialog<String>(
          ...
          builder: (BuildContext context) => AlertDialog(
            ...
            content: const Text(
                'M. Aditya H.P. (mdhstama@upi.edu) ; Alvin Giovani (alvingiovani17@upi.edu)'),
            actions: <Widget>[
              TextButton(
